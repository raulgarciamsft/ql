// semmle-extractor-options: /r:System.Security.Cryptography.Algorithms.dll /r:System.Security.Cryptography.Primitives.dll /r:System.Security.Cryptography.Csp.dll /r:System.Runtime.Extensions.dll /r:System.IO.FileSystem.dll
using System;
using System.IO;
using System.Text;
using System.Security.Cryptography;
namespace TestHardcodedKey
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string byteArrayFromString = "Hello, world: here is a very bad way to create a key";
            ...
            var ct1 = Encrypt("Test string here", Encoding.UTF8.GetBytes(byteArrayFromString), iv);
